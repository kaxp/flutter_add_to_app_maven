...
class _ProductApiClient implements ProductApiClient {
  ...
  Future<ProductCategoriesResponse> getProductCategories() async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ProductCategoriesResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<ProductListingResponse> getProductListing(
      {required ProductListingRequest body}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ProductListingResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ProductListingResponse.fromJson(_result.data!);
    return value;
  }

  @override
  Future<ProductDetailResponse> getProductDetail(
      {required ProductDetailRequest body}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
